# Generated by Django 5.1.4 on 2025-01-11 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_url', cloudinary.models.CloudinaryField(max_length=255, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(related_name='find_room_post', to='app.image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Allow', 'Allow'), ('Deny', 'Deny')], default='Pending', max_length=20)),
                ('images', models.ManyToManyField(related_name='rental_post', to='app.image')),
